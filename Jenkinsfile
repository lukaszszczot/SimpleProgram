        ...
        stage('User Input') {
            steps {
                script {
                    ...
                    [$class: 'hudson.model.BooleanParameterDefinition, defaultValue: false, description: 'To jest BooleanParameterDefinition', name: 'opcja1'],
                    [$class: 'hudson.model.BooleanParameterDefinition, defaultValue: false, description: 'To jest BooleanParameterDefinition', name: 'opcja2'],
                    [$class: 'hudson.model.BooleanParameterDefinition, defaultValue: false, description: 'To jest BooleanParameterDefinition', name: 'opcja3'],
                    [$class: 'hudson.model.BooleanParameterDefinition, defaultValue: false, description: 'To jest BooleanParameterDefinition', name: 'opcja4'],
                    [$class: 'hudson.model.BooleanParameterDefinition, defaultValue: false, description: 'To jest BooleanParameterDefinition', name: 'opcja5'],
                    [$class: 'hudson.model.BooleanParameterDefinition, defaultValue: false, description: 'To jest BooleanParameterDefinition', name: 'opcja6'],
                    [$class: 'hudson.model.BooleanParameterDefinition, defaultValue: false, description: 'To jest BooleanParameterDefinition', name: 'opcja7'],
                    [$class: 'hudson.model.BooleanParameterDefinition, defaultValue: false, description: 'To jest BooleanParameterDefinition', name: 'opcja8'],
                    [$class: 'hudson.model.BooleanParameterDefinition, defaultValue: false, description: 'To jest BooleanParameterDefinition', name: 'opcja9'],
                    [$class: 'hudson.model.BooleanParameterDefinition, defaultValue: false, description: 'To jest BooleanParameterDefinition', name: 'opcja10'],
                    [$class: 'hudson.model.BooleanParameterDefinition, defaultValue: false, description: 'To jest BooleanParameterDefinition', name: 'opcja11'],
                    [$class: 'hudson.model.BooleanParameterDefinition, defaultValue: false, description: 'To jest BooleanParameterDefinition', name: 'opcja12'],
                    [$class: 'hudson.model.BooleanParameterDefinition, defaultValue: false, description: 'To jest BooleanParameterDefinition', name: 'opcja13'],
                    [$class: 'hudson.model.BooleanParameterDefinition, defaultValue: false, description: 'To jest BooleanParameterDefinition', name: 'opcja14'],
                    [$class: 'hudson.model.BooleanParameterDefinition, defaultValue: false, description: 'To jest BooleanParameterDefinition', name: 'opcja15'],
